                    ...
                    <div className='flex flex-col justify-center h-full text-left w-full space-y-4'>
                        ...
                        <div className="space-y-6 ">
                            <p className="text-sm leading-loose">
                                a diligent software developer with a fervent desire to delve into the realm of <Link to='/projects' className="underline underline-offset-4">development</Link>.
